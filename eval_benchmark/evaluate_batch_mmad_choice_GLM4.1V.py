        ...
        with tqdm(dataloader) as pbar:
            for llm_inputs, answer_entry in pbar:
                ...
                for ith_a, gpt_output in enumerate(gpt_answers):
                    ...
                    content_match = re.findall(r'<\|begin_of_box\|>(.*?)<\|end_of_box\|>', gpt_output, re.DOTALL)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint', type=str, help="Root directory for MLLM model")  ####很久，自带think
